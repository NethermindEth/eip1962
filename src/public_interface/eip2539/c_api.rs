...
{            
    ...
    let err_out_i8: &mut [i8] = unsafe { std::slice::from_raw_parts_mut(err as *mut i8, EIP2539_PREALLOCATE_FOR_ERROR_BYTES) };
    ...
    let raw_out_i8: &mut [i8] = unsafe { std::slice::from_raw_parts_mut(o as *mut i8, EIP2539_PREALLOCATE_FOR_RESULT_BYTES) };
